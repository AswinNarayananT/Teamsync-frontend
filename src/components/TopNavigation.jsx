  ...
  return (
    <div className="h-16 bg-[#121214] border-b border-[#2a2a2d] flex justify-between items-center px-4 sm:px-6 shadow-md">
      ...
      <div className="flex items-center space-x-2 sm:space-x-4">
        ...
        <button className="hidden sm:inline-block relative p-2 text-gray-300 hover:text-white hover:bg-[#2a2a2d] rounded-full transition-colors duration-200">
        ...
        <button className="hidden sm:inline-block p-2 text-gray-300 hover:text-white hover:bg-[#2a2a2d] rounded-full transition-colors duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
